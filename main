...
def jogar():
    ...
    while True:
        if chances <= 0:
            print('Você perdeu!!!')
            time.sleep(2)
            escrever_resultado(secreto, f'Desafiante {nome_desafiante}', f'Competidor {nome_competidor}')
            break
        ...
        if secreto_temporario == secreto:
            ...
            time.sleep(3)
            escrever_resultado(secreto, f'Competidor {nome_competidor}', f'Desafiante {nome_desafiante}')
            break
        else:
